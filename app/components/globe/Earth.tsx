...
import { loadTexture, EARTH_TEXTURES } from "./textureLoader";
...
export function Earth({ radius = 2, rotationSpeed = 0.05 }) {
  ...
  return (
    <group ref={groupRef}>
      ...
      <mesh><sphereGeometry args={[radius * 1.05, 64, 64]} /><meshBasicMaterial color={0x4a90d9} transparent opacity={0.1} side={THREE.BackSide} blending={THREE.AdditiveBlending} /></mesh>
    </group>
  );
}
